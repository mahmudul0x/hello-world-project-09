...
//#region node_modules/.nitro/vite/services/ssr/assets/SiteLayout-DT7KZ3Zi.js
...
function Navbar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(motion.header, {
		...
		className: cn("sticky top-0 z-50 w-full border-b transition-all duration-500", scrolled ? "border-border/60 bg-background/95 shadow-luxury backdrop-blur-xl" : "border-transparent bg-background/90 shadow-soft-lux backdrop-blur"),
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
